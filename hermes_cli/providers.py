...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "devin": HermesOverlay(transport="chat_completions", auth_type="external_process",
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "copilot-acp": "GitHub Copilot ACP", "devin": "Devin", "stepfun": "StepFun Step Plan", "xiaomi": "Xiaomi MiMo", "gmi": "GMI Cloud",
